...
Product.OptionsPrice.prototype = {
	...
	initPrices: function() {
		...
		this.containers[5] = 'old-price2-' + this.productId;
		this.containers[6] = 'disc-price-' + this.productId;
	},
		...
		$H(this.containers).each(function(pair) {
			...
			if ($(pair.value)) {
				...
				if ($(pair.value).select('.price')[0]) {
					...
					if(formattedPrice == '') {
						//alert('Price is zero');
						$(pair.value).select('.price')[0].hide();
						// $(pair.value).select('.price2')[0].show();
					}
					else {
						...
						$(pair.value).select('.price')[0].show();
						//$(pair.value).select('.price2')[0].hide();
					}
				} else {
