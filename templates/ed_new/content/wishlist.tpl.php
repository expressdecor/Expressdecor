...
?>
		<div>
			<div style="float:left; width: 300px;"><img src="/templates/ed_new/img/wishlist-top.png" alt="" /></div>
		</div>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td class="main">
        	<?php echo tep_draw_form('wishlist_quantity', tep_href_link(FILENAME_WISHLIST, 'action=update_wishlist'), 'post', 'id="wishlist_quantity"') . tep_draw_hidden_field('targetAddress', ''); ?>
...
?>
							...
							<td align="center" class="productListing-data" valign="top" style="border-bottom: 4px solid #d5d5d5;">
								<div><?php echo tep_draw_input_field('wishlist_quantity[]', $products[$i]['quantity'], 'size="3" style="border:1px solid black; font-size: 14px; font-weight: bold; width: 30px; text-align:center;"') . tep_draw_hidden_field('products_id[]', $products[$i]['id']); ?></div>
								<div>&nbsp;</div>
								<div><a href="javascript:updateWishlist('wishlist');"><?php echo tep_image_button('button_update_cart.gif','update', ' style="margin-bottom:5px;"'); ?></a></div>
								<div><a href="<?php echo tep_href_link('wishlist.php', 'action=wishlist_addcart&products_id='. $products[$i]['id']); ?>"><img src="/templates/ed_new/img/wishlist_addcart.png" alt="" class="border" style="margin-bottom:5px;" /></a></div>
								<div><a href="<?php echo tep_href_link('wishlist.php', 'action=wishlist_remove&products_id='. $products[$i]['id']); ?>"><?php echo tep_image_button('button_remove_cart.gif','update'); ?></a></div>
							</td>
...
<?php } ?>
									...
									<tr>
										<td class="border" style="padding: 5px;">
											<div style="float: left; width: 500px;">
												<div style="color:#fe792f; font-size: 16px; font-weight:bold;">Save Wish list</div>
								...
								<table border="0" style="background-color:#d5d5d5; border: 5px solid #d5d5d5; width: 100%; height: 182px;">
										...
										<td style="height:50px;">
											<table style="width:100%;">
												<tr>
													...
													<td align="right"><strong style="font-size:14px; color:#786b66;"><?php echo $currencies->format($wishlist->show_total()); ?></strong></td>
												</tr>
												<tr>
									...
									<tr>
										<td style="background-color:#FFF; height:115px;" align="center">
											<div class="wishlist-buttons-block">Go to</div>
											<div><a href="<?php echo tep_href_link(FILENAME_SHOPPING_CART); ?>"><img src="/templates/ed_new/img/shopping_cart_btn.png" alt="" /></a></div>
											<div class="wishlist-buttons-block">or</div>
											<div><a href="<?php echo HTTP_SERVER; ?>"><img src="/templates/ed_new/img/continue_shopping_btn.png" alt="" /></a></div>
										</td>
									</tr>
								</table>
							</td>
      ...
      <tr>
		...
		<script type="text/javascript">
			function updateWishlist(targetAddr) {
				document.getElementById('wishlist_quantity').targetAddress.value=targetAddr;
				document.getElementById('wishlist_quantity').submit();
			}
		</script>
    <?php
      } else {
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
      	<td width="390"><img src="/templates/ed_new/img/wishlist-top.png" alt="" /></td>
        <td align="center">
        	<table cellpadding="0" cellspacing="0">
        		<tr>
        			<td colspan="3" align="center" style="font-size: 18px; font-weight: bold; padding-bottom: 10px;">Your Wish List is Empty</td>
        		</tr>
        		<tr>
        			<td><a href="<?php echo tep_href_link(FILENAME_SHOPPING_CART); ?>"><img src="/templates/ed_new/img/shopping_cart_btn.png" alt="" /></a></td>
        			<td width="30">&nbsp;</td>
        			<td><a href="<?php echo HTTP_SERVER; ?>"><img src="/templates/ed_new/img/continue_shopping_btn.png" alt="" /></a></td>
        		</tr>
        	</table>
        </td>
      </tr>
