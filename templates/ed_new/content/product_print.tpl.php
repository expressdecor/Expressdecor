...
//added by soel for Products Viewed
tep_db_query("insert into products_viewed set products_id = " . (int)$HTTP_GET_VARS['products_id'] . ", datetime = ".strtotime('Now'));
// eo of soel Add
...
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="pageHeading" valign="top" style="padding-left:5px"><?php echo $products_name; ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
?>
		...
		<script type="text/javascript"><!--
		      document.write('<?php echo '<a href="javascript:popupWindow(\\\'' . tep_href_link(FILENAME_POPUP_IMAGE, 'pID=' . $product_info['products_id']) . '\\\')">' . tep_image1(DIR_WS_IMAGES . $new_image, addslashes($product_info['products_name']), 200) . '<br></a>'; ?>');
		//--></script>
...
?>
		  <br/><?php echo stripslashes($product_info['products_description']); ?>
        </td>
