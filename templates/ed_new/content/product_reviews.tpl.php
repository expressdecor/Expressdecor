    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
            <td colspan=2>View this product by going to:<a href="<?php tep_href_link('product_info.php/products_id/'.$product_info['products_id'])?>"><?php $product_info['products_name']?></a></td>            
          </tr>
        </table>
...
<?php
  $reviews_query_raw = "select r.reviews_id, rd.reviews_text, r.reviews_rating, r.date_added, r.customers_name from " . TABLE_REVIEWS . " r, " . TABLE_REVIEWS_DESCRIPTION . " rd where r.products_id = '" . (int)$product_info['products_id'] . "' and r.reviews_id = rd.reviews_id and rd.languages_id = '" . (int)$languages_id . "' order by r.reviews_id desc";
                  ...
                  <tr class="infoBoxContents">
                    <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                      <tr>
                        ...
                        <td valign="top" class="main"><?php echo tep_output_string_protected($reviews['reviews_text']) . '<br><br><i>' . sprintf(TEXT_REVIEW_RATING, tep_image(DIR_WS_IMAGES . 'stars_' . $reviews['reviews_rating'] . '.gif', sprintf(TEXT_OF_5_STARS, $reviews['reviews_rating'])), sprintf(TEXT_OF_5_STARS, $reviews['reviews_rating'])) . '</i>'; ?></td>
