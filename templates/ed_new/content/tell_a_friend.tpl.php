	<div style="border-bottom: 1px solid #ccc;"><img src="/templates/ed_new/img/tell_a_friend-top.jpg" alt="" /></div>
...
?>
		<tr>
			<td colspan="2" style="border-top: 1px solid #ccc">
				<table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td class="main" width="170"><?php echo FORM_FIELD_CUSTOMER_NAME; ?><span class="inputRequirement">*</span></td>
						<td class="main"><?php echo tep_draw_input_field('from_name'); ?></td>
					</tr>
					<tr>
						<td class="main" width="170"><?php echo FORM_FIELD_CUSTOMER_EMAIL; ?><span class="inputRequirement">*</span></td>
		...
		<tr>
			<td colspan="2">
				<table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td class="main" width="170"><?php echo FORM_FIELD_FRIEND_NAME; ?><span class="inputRequirement">*</span></td>
						<td class="main"><?php echo tep_draw_input_field('to_name'); ?></td>
					</tr>
					<tr>
						<td class="main" width="170"><?php echo FORM_FIELD_FRIEND_EMAIL; ?><span class="inputRequirement">*</span></td>
						<td class="main"><?php echo tep_draw_input_field('to_email_address'); ?></td>
					</tr>
				</table>
			</td>
		</tr>
