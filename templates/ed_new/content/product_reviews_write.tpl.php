        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main"><?php echo '<b>' . SUB_TITLE_FROM . '</b> '. ($allow_reviews? tep_draw_input_field('from', '') :tep_output_string_protected($customer['customers_firstname'] . ' ' . $customer['customers_lastname'])); ?></td>
              </tr>
              <?php if ($allow_reviews) { ?>
              <tr>
                <td class="main"><?php echo '<b>Time: </b> '. tep_draw_input_field('datetime', date('Y-m-d H:i:s')); ?></td>
              </tr>
              <?php } ?>
              <tr>
