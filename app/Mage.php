...
final class Mage
{
    ...
    public static function cDebug($DebugPath, $DebugMessage)
    {
        $DebugMessage = str_replace('"','',$DebugMessage);
        $write = Mage::getSingleton('core/resource')->getConnection('core_write');
        $write->query("insert into magento_custom_debug (DebugTimestamp, DebugPath, DebugMessage) values (NOW(),\"".$DebugPath."\",\"".$DebugMessage."\")");
    }
