 ...
 */
class Mageed_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        //Mage::cDebug('Mage_Adminhtml_Block_Sales_Order_Grid', $this->_getCollectionClass());
        //we changed mysql query, we added inner join to order item table sales_flat_order_payment
