    ...
    extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    public function editAction()
    {
        ...
        $this->_initAction()
             ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_amazon_template_synchronization_edit'))
             ->_addLeft($this->getLayout()->createBlock('M2ePro/adminhtml_amazon_template_synchronization_edit_tabs'))
             ->renderLayout();
    }
    ...
    public function saveAction()
    {
        ...
        $temp = Ess_M2ePro_Model_Amazon_Template_Synchronization::RELIST_SCHEDULE_TYPE_WEEK;
