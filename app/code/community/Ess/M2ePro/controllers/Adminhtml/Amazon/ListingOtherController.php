...
class Ess_M2ePro_Adminhtml_Amazon_ListingOtherController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    public function gridAction()
    {
        $response = $this->loadLayout()->getLayout()
                         ->createBlock('M2ePro/adminhtml_amazon_listing_other_grid')->toHtml();
    ...
    public function mapToProductAction()
    {
        ...
        if ($magentoProduct->isProductWithVariations()) {
            ...
            $messageString = Mage::getModel('M2ePro/Log_Abstract')->encodeDescription(
                // Parser hack -> Mage::helper('M2ePro')->__('Item was not mapped as the chosen %id%
                //                     Simple Product has Custom Options. Please, choose another Simple Product.');
    ...
    public function mapAutoToProductAction()
    {
        ...
        foreach ($productIds as $productId) {
            ...
            $listingOther = Mage::helper('M2ePro/Component_Amazon')
    ...
    public function unmapToProductAction()
    {
        ...
        if(!$listingOtherProductId) {
            ...
            return $this->_redirect('*/adminhtml_listingOther/index/tab/amazon/');
        }
