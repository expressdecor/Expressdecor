...
class Ess_M2ePro_Adminhtml_Ebay_Template_SynchronizationController
    extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    public function editAction()
    {
        ...
        $model = Mage::helper('M2ePro/Component_Ebay')->getModel('Template_Synchronization')->load($id);
        ...
        $this->_initAction()
             ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_ebay_template_synchronization_edit'))
             ->_addLeft($this->getLayout()->createBlock('M2ePro/adminhtml_ebay_template_synchronization_edit_tabs'))
             ->renderLayout();
    }
    ...
    public function saveAction()
    {
        ...
        $temp = Ess_M2ePro_Model_Ebay_Template_Synchronization::RELIST_SCHEDULE_TYPE_WEEK;
        ...
        // Add or update model
        //--------------------
        $model = Mage::helper('M2ePro/Component_Ebay')->getModel('Template_Synchronization');
