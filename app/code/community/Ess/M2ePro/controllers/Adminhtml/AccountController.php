    ...
    public function deleteAction()
    {
        ...
        if ($isGeneralTpl) {
            $tempString = $isListing
                ? Mage::helper('M2ePro')->__('%count% record(s) are used in M2E Listing(s) or General Template(s). ')
                : Mage::helper('M2ePro')->__('%count% record(s) are used in General Template(s). ');
            $tempString .= Mage::helper('M2ePro')->__('Account must not be in use to be deleted.');
        } elseif ($isListing) {
            $tempString  = Mage::helper('M2ePro')->__('%count% record(s) are used in M2E Listing(s). ');
            $tempString .= Mage::helper('M2ePro')->__('Account must not be in use to be deleted.');
        }
