...
class Ess_M2ePro_Adminhtml_SynchronizationController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    public function synchCheckProcessingNowAction()
    {
        ...
        if ($synchronizationEbayOtherListingsProcessing > 0) {
            $messageTemp = Mage::helper('M2ePro')->__('eBay 3rd Party Listings are being downloaded now. ');
            $messageTemp .= Mage::helper('M2ePro')
                    ->__('They will be available soon in eBay / Amazon > Manage Listing > 3rd Party Listings. ');
            $messageTemp .= Mage::helper('M2ePro')
                    ->__('You can continue working with M2E Pro.');

            $warningMessages[] = $messageTemp;
        }
