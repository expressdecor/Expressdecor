...
class Ess_M2ePro_Adminhtml_MarketplaceController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    public function runSynchNowAction()
    {
        ...
        $markeptlaceObj = Mage::helper('M2ePro/Component')->getUnknownObject('Marketplace',$marketplaceId);
        ...
        $synchDispatcher->setComponents(array($markeptlaceObj->getComponentMode()));
