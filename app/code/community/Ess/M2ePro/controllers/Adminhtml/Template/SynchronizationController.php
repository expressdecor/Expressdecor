...
class Ess_M2ePro_Adminhtml_Template_SynchronizationController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    {
        $this->_initAction()
             ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_template_synchronization'))
             ->renderLayout();
    }

    public function gridAction()
    {
        $block = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_template_synchronization_grid');
    ...
    public function editAction()
    {
        ...
        return $this->_redirect(
            "*/adminhtml_{$template->getComponentMode()}_template_synchronization/edit", array('id'=>$id)
        );
    }
