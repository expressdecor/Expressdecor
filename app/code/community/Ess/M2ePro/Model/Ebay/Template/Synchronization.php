...
class Ess_M2ePro_Model_Ebay_Template_Synchronization extends Ess_M2ePro_Model_Component_Child_Ebay_Abstract
{
    ...
    const RELIST_LIST_MODE_NONE = 0;
    const RELIST_LIST_MODE_YES  = 1;
    ...
    public function isRelistListMode()
    {
        return $this->getData('relist_list_mode') != self::RELIST_LIST_MODE_NONE;
    }
