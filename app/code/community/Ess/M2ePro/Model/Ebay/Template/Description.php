...
class Ess_M2ePro_Model_Ebay_Template_Description extends Ess_M2ePro_Model_Component_Child_Ebay_Abstract
{
    ...
    public function addWatermarkIfNeed($imageLink)
    {
        ...
        $tempPath = implode('.', $parts);

        $markingImagePath = $tempPath.'-'.$this->getWatermarkHash().$fileExtension;
        ...
        $prevMarkingImagePath = $tempPath.'-'.$this->getWatermarkPreviousHash().$fileExtension;
