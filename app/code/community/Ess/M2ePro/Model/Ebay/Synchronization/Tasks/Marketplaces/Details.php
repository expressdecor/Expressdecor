    ...
    extends Ess_M2ePro_Model_Ebay_Synchronization_Tasks
{
    ...
    private function execute()
    {
        ...
        foreach ($marketplaces as $marketplace) {
            ...
            // ->__('The "Receive Details" action for marketplace: "%mrk%" is started. Please wait...')
            $status = 'The "Receive Details" action for marketplace: "%mrk%" is started. Please wait...';
            $tempString = str_replace(
                '%mrk%',
                Mage::helper('M2ePro')->__($marketplace->getTitle()),
                Mage::helper('M2ePro')->__($status)
            );
            ...
            // ->__('The "Receive Details" action for marketplace "%mrk%" is in data processing mode. Please wait...')
            $status = 'The "Receive Details" action for marketplace "%mrk%" is in data processing mode. Please wait...';
            $tempString = str_replace(
                '%mrk%',
                Mage::helper('M2ePro')->__($marketplace->getTitle()),
                Mage::helper('M2ePro')->__($status)
