...
class Ess_M2ePro_Model_Ebay_Synchronization_Tasks_Templates_Start extends Ess_M2ePro_Model_Ebay_Synchronization_Tasks
{
    ...
    private function executeListAllStoppedItems()
    {
        ...
        foreach ($this->_synchronizations as &$synchronization) {
            ...
            foreach ($synchronization['listings'] as &$listing) {
                ...
                if (!$synchronization['instance']->getChildObject()->isStartAutoList()) {
                    continue;
                }

                $filters = array('status'=>array('nin'=>array(Ess_M2ePro_Model_Listing_Product::STATUS_LISTED)));
