    ...
    extends Ess_M2ePro_Model_Ebay_Synchronization_Tasks
{
    ...
    private function execute()
    {
        ...
        //------------------------------------
        $changedListingsOthers = Mage::getModel('M2ePro/Listing_Other')
        ...
        //------------------------------------
        foreach ($changedListingsOthers as $changedListingOther) {

            /** @var $listingOther Ess_M2ePro_Model_Listing_Other */
            $listingOther = Mage::helper('M2ePro/Component_Ebay')
                ->getObject('Listing_Other',$changedListingOther['id']);
