    ...
    extends Ess_M2ePro_Model_Ebay_Synchronization_Tasks
{
    ...
    private function execute()
    {
        ...
        foreach ($marketplaces as $marketplace) {
            ...
            // ->__('The "Categories Synchronization" action for marketplace: "%mrk%" is started. Please wait...')
            $status = 'The "Categories Synchronization" action for marketplace: "%mrk%" is started. Please wait...';
