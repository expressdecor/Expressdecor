    ...
    extends Ess_M2ePro_Model_Ebay_Synchronization_Tasks
{
    ...
    private function processAccount(Ess_M2ePro_Model_Account $account, $percentsForAccount)
    {
        ...
        // ->__('Task "Orders Cancellation Synchronization" for eBay account: "%acc%" is started. Please wait...')
        $status = 'Task "Orders Cancellation Synchronization" for eBay account: "%acc%" is started. Please wait...';
        ...
        $status .= '"%acc%" is in data processing state. Please wait...';
