...
class Ess_M2ePro_Model_Ebay_Synchronization_Tasks_Templates_End extends Ess_M2ePro_Model_Ebay_Synchronization_Tasks
{
            ...
            foreach ($synchronization['listings'] as &$listing) {
                ...
                foreach ($listingsProducts as $listingProduct) {
                    ...
                    $this->_runnerActions->setProduct(
                        $listingProduct,Ess_M2ePro_Model_Connector_Server_Ebay_Item_Dispatcher::ACTION_STOP,array()
                    );
                }
            }
        }
