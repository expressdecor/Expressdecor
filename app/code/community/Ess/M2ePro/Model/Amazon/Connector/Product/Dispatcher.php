...
class Ess_M2ePro_Model_Amazon_Connector_Product_Dispatcher
{
    ...
    private $connectorMode = Ess_M2ePro_Model_Amazon_Connector::MODE_SERVER;
    ...
    {
        $result = Ess_M2ePro_Model_Amazon_Connector_Product_Requester::STATUS_ERROR;
        ...
        switch ($action) {
            case self::ACTION_LIST:
                $result = $this->processGroupedProducts($sortedProductsData,
                                                        1000,
                                                        'Ess_M2ePro_Model_Connector_'
                                                            .ucfirst($this->getConnectorMode())
                                                            .'_Amazon_Product_List_Multiple',
                                                        $params);
                break;
            ...
            case self::ACTION_RELIST:
                $result = $this->processGroupedProducts($sortedProductsData,
                                                        ...
                                                        'Ess_M2ePro_Model_Connector_'
                                                            .ucfirst($this->getConnectorMode())
                                                            .'_Amazon_Product_Relist_Multiple',
                                                        $params);
                break;
            ...
            case self::ACTION_REVISE:
                $result = $this->processGroupedProducts($sortedProductsData,
                                                        ...
                                                        'Ess_M2ePro_Model_Connector_'
                                                            .ucfirst($this->getConnectorMode())
                                                            .'_Amazon_Product_Revise_Multiple',
                                                        $params);
                break;
            ...
            case self::ACTION_DELETE:
                $result = $this->processGroupedProducts($sortedProductsData,
                                                        ...
                                                        'Ess_M2ePro_Model_Connector_'
                                                            .ucfirst($this->getConnectorMode())
                                                            .'_Amazon_Product_Delete_Multiple',
                                                        $params);
                break;
    ...
    public function setConnectorMode($connectorMode)
    {
        $this->connectorMode = $connectorMode;
    }

    public function getConnectorMode()
    {
    ...
    protected function processProducts(array $products, $connectorName, array $params = array())
    {
        try {
            ...
            return Ess_M2ePro_Model_Amazon_Connector_Product_Requester::STATUS_ERROR;
        }
    }
    ...
    protected function sortProductsByAccountAndMarketplace($products)
    {
        ...
        foreach ($products as $product) {
            ...
            $accountId = $product->getGeneralTemplate()->getAccountId();
            $marketplaceId = $product->getGeneralTemplate()->getMarketplaceId();
