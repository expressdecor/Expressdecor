...
class Ess_M2ePro_Model_Amazon_Synchronization_Tasks_OtherListings_ServerResponser extends
                                                Ess_M2ePro_Model_Connector_Server_Amazon_Inventory_Get_ItemsResponser
{
    ...
    {
        /** @var $tempModel Ess_M2ePro_Model_Amazon_Synchronization_Tasks_OtherListings_Responser */
        $tempModel = Mage::getModel('M2ePro/Amazon_Synchronization_Tasks_OtherListings_Responser');
