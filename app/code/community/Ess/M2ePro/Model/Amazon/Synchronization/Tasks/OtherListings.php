...
class Ess_M2ePro_Model_Amazon_Synchronization_Tasks_OtherListings extends Ess_M2ePro_Model_Amazon_Synchronization_Tasks
{
                                              ...
                                              Ess_M2ePro_Model_Marketplace $marketplaceObj)
    {
        ...
        $tempString = Mage::helper('M2ePro')->__('Task "3rd Party Listings Synchronization" for Amazon account: ');
        $tempString .= Mage::helper('M2ePro')->__('"%acc%" and marketplace "%mark%" is started. Please wait...');
        $tempString = str_replace(array('%acc%','%mark%'),
                                  array($accountObj->getTitle(),
                                        $marketplaceObj->getTitle()),
                                  $tempString);
