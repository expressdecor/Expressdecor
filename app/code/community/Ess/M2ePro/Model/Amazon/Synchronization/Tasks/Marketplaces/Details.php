    ...
    private function execute()
    {
        ...
        foreach ($marketplaces as $marketplace) {
            ...
            $temp = Mage::helper('M2ePro')->__(
                'The "Receive Details" action for marketplace: "%mrk%" is started. Please wait...'
            );
            ...
            $temp = Mage::helper('M2ePro')->__(
                'The "Receive Details" action for marketplace: "%mrk%" is in data processing mode. Please wait...'
            );
            $tempString = str_replace('%mrk%',
                                      Mage::helper('M2ePro')->__($marketplace->getTitle()),
                                      $temp);
        ...
        // Parser hack -> Mage::helper('M2ePro')->__('The "Receive Details" action for marketplace:
