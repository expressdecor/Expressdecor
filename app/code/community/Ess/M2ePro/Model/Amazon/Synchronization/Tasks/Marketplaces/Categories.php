...
class Ess_M2ePro_Model_Amazon_Synchronization_Tasks_Marketplaces_Categories extends
    ...
    private function execute()
    {
        ...
        foreach ($marketplaces as $marketplace) {
            ...
            $temp = Mage::helper('M2ePro')->__(
                'The "Categories Synchronization" action for marketplace: "%mrk%" is started. Please wait...'
            );
            ...
            // Create connector
            //-----------------------
            $categories = Mage::getModel('M2ePro/Connector_Server_Amazon_Dispatcher')
            ...
            $temp .= '"%mrk%" is in data processing mode. Please wait...';
            $tempString = str_replace(
                '%mrk%', Mage::helper('M2ePro')->__($marketplace->getTitle()), Mage::helper('M2ePro')->__($temp)
            );
            $this->_lockItem->setStatus($tempString);
