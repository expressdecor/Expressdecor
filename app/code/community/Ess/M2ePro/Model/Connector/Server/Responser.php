    ...
    protected function processResponseMessages(array $messages = array())
    {
        ...
        if ($this->resultType == Ess_M2ePro_Model_Connector_Server_Protocol::MESSAGE_TYPE_ERROR) {
            ...
            foreach ($this->messages as $message) {
                ...
                $type = $message[Ess_M2ePro_Model_Connector_Server_Protocol::MESSAGE_TYPE_KEY];
                $sender = $message[Ess_M2ePro_Model_Connector_Server_Protocol::MESSAGE_SENDER_KEY];

                if ($type == Ess_M2ePro_Model_Connector_Server_Protocol::MESSAGE_TYPE_ERROR &&
                    $sender == Ess_M2ePro_Model_Connector_Server_Protocol::MESSAGE_SENDER_SYSTEM) {
