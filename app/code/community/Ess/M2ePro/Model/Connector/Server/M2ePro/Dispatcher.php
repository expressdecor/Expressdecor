...
class Ess_M2ePro_Model_Connector_Server_M2ePro_Dispatcher
{
    //####################################
     ...
     * @param string $name
     * @param array $params
     * @return Ess_M2ePro_Model_Connector_Server_M2ePro_Abstract
     */
    public function getConnector($entity, $type, $name, array $params = array())
    {
        ...
        $className = 'Ess_M2ePro_Model_Connector_Server_M2ePro';
