...
class Ess_M2ePro_Model_Connector_Server_Amazon_Product_Revise_MultipleResponser
    extends Ess_M2ePro_Model_Connector_Server_Amazon_Product_Responser
{
    ...
    protected function getSuccessfullyMessage($nativeRequestData)
    {
        ...
        if (isset($this->params['params']['only_data']['variations']) &&
            isset($nativeRequestData['is_variation_item']) &&
            $nativeRequestData['is_variation_item']) {
