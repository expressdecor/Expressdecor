...
abstract class Ess_M2ePro_Model_Connector_Server_Amazon_Product_Responser
    extends Ess_M2ePro_Model_Connector_Server_Amazon_Responser
{
    ...
    protected function processResponseData($response)
    {
        ...
        foreach ($this->listingsProducts as $listingProduct) {
            ...
            foreach ($globalMessages as $message) {
                ...
                $text = $message[Ess_M2ePro_Model_Connector_Server_Protocol::MESSAGE_TEXT_KEY];
    ...
    {
        switch ($message[Ess_M2ePro_Model_Connector_Server_Protocol::MESSAGE_TYPE_KEY]) {
            case Ess_M2ePro_Model_Connector_Server_Protocol::MESSAGE_TYPE_WARNING:
            case Ess_M2ePro_Model_Connector_Server_Protocol::MESSAGE_TYPE_SUCCESS:
            case Ess_M2ePro_Model_Connector_Server_Protocol::MESSAGE_TYPE_NOTICE:
                    return false;
            case Ess_M2ePro_Model_Connector_Server_Protocol::MESSAGE_TYPE_ERROR:
            default:
                   return true;
        }
    }
