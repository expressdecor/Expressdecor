...
class Ess_M2ePro_Model_Connector_Server_Amazon_Dispatcher
{
    //####################################
     ...
     * @return Ess_M2ePro_Model_Connector_Server_Amazon_Requester|Ess_M2ePro_Model_Connector_Server_Amazon_Abstract
     */
    ...
    {
        $className = empty($ormPrefixToConnector) ? 'Ess_M2ePro_Model_Connector_Server_Amazon' : $ormPrefixToConnector;
