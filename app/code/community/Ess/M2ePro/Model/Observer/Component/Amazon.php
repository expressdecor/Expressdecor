...
class Ess_M2ePro_Model_Observer_Component_Amazon
{
    //####################################

    public function m2eproAssociateAmazonOrderItemToProduct(Varien_Event_Observer $observer)
    {
        try {
            ...
            if($collection->getSize() > 0 && is_null($collection->getFirstItem()->getData('product_id'))) {
                ...
                $productOtherInstance = Mage::helper('M2ePro/Component_Amazon')
                                                        ...
                                                        ->load($collection->getFirstItem()->getId());
