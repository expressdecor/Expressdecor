...
class Ess_M2ePro_Block_Adminhtml_Wizard_Ebay_Installation_Marketplace extends Mage_Adminhtml_Block_Template
{
    // ########################################
    ...
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('wizardEbayInstallationMarketplace');
        //------------------------------

        $this->setTemplate('M2ePro/wizard/ebay/installation/marketplace.phtml');
    }
