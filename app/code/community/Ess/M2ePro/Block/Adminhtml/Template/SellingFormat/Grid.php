...
class Ess_M2ePro_Block_Adminhtml_Template_SellingFormat_Grid extends Ess_M2ePro_Block_Adminhtml_Component_Grid
{
    ...
    {
        return $this->getComponentRowUrl($row, 'template_sellingFormat', 'edit', array('id' => $row->getData('id')));
    }
