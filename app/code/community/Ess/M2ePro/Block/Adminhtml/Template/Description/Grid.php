...
class Ess_M2ePro_Block_Adminhtml_Template_Description_Grid extends Ess_M2ePro_Block_Adminhtml_Component_Grid
{
    ...
    public function callbackColumnAttributeSets($value, $row, $column, $isExport)
    {
        ...
        foreach ($attributeSets as $attributeSet) {
            ...
            if (isset($this->attributeSets[$attributeSet->getData('attribute_set_id')])) {
                $value != '' && $value .= ', ';
                $value .= $this->attributeSets[$attributeSet->getData('attribute_set_id')];
            }
        }
    ...
    {
        return $this->getComponentRowUrl($row, 'template_description', 'edit', array('id' => $row->getData('id')));
    }
