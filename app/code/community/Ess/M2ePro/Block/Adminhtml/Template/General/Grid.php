...
//        exit($collection->getSelect()->__toString());
    ...
    protected function _prepareColumns()
    {
        ...
        $accountFilter = $this->getFilterOptionsByModel('Account');
        ...
        $this->addColumn('account_id', array(
            ...
            'option_groups'  => $accountFilter['option_groups'],
            'frame_callback' => array($this, 'callbackColumnAccount')
        ));

        $marketplaceFilter = $this->getFilterOptionsByModel('Marketplace');
        ...
        $this->addColumn('marketplace_id', array(
            ...
            'option_groups'  => $marketplaceFilter['option_groups'],
