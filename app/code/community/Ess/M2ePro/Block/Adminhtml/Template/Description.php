...
class Ess_M2ePro_Block_Adminhtml_Template_Description extends Ess_M2ePro_Block_Adminhtml_Component_Grid_Container
{
    // ####################################
    ...
    {
        return $this->getUrl('*/adminhtml_ebay_template_description/new');
    }

    protected function getAmazonNewUrl()
    {
        return $this->getUrl('*/adminhtml_amazon_template_description/new');
    }
