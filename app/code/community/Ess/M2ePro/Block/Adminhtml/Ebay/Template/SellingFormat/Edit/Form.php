...
class Ess_M2ePro_Block_Adminhtml_Ebay_Template_SellingFormat_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    //#############################################
    ...
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('ebayTemplateSellingFormatEditForm');
        //------------------------------

        $this->setTemplate('M2ePro/ebay/template/selling_format/form.phtml');
    }
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->setData('currencies',
                       Mage::helper('M2ePro/Module')->getConfig()
                                                ->getAllGroupValues('/ebay/currency/',
        ...
        $buttonBlock = $this->getLayout()
                            ...
                            ->setData( array(
                                ...
                                'onclick' => 'EbayTemplateSellingFormatHandlerObj.attribute_sets_confirm();',
