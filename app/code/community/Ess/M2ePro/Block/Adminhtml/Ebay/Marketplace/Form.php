...
class Ess_M2ePro_Block_Adminhtml_Ebay_Marketplace_Form extends Mage_Adminhtml_Block_Widget_Form
{
    // ########################################
    ...
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('ebayMarketplaceForm');
        $this->setContainerId('magento_block_ebay_marketplaces');
        $this->setTemplate('M2ePro/ebay/marketplace.phtml');
        //------------------------------
    }
