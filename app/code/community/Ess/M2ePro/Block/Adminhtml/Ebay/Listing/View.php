...
class Ess_M2ePro_Block_Adminhtml_Ebay_Listing_View extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function getGridHtml()
    {
        ...
        $tempString = '"%title%" task has completed with warnings. <a href="%url%">View log</a> for details.';
        ...
        $tempString = '"%title%" task has completed with errors. <a href="%url%">View log</a> for details.';
