...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $headerText = Mage::helper('M2ePro')->__("Edit \"%title%\"%component_name% Listing [Settings]");
        ...
        if (!is_null($this->getRequest()->getParam('back'))) {
            ...
            $this->_addButton('back', array(
                ...
                'onclick'   => 'AmazonListingSettingsHandlerObj.back_click(\''.Mage::helper('M2ePro')
        ...
        $this->_addButton('save', array(
            ...
            'onclick'   => 'AmazonListingSettingsHandlerObj.save_click(\''
                            .$this->getUrl('*/adminhtml_amazon_listing/save',
