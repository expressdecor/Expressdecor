...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $filterDescriptionTemplate = $this->getRequest()->getParam('filter_amazon_description_template');
        ...
        $this->addColumn('actions', array(
            ...
            'actions'   => array(
                array(
                    ...
                    'url' => array(
                              'base'=> '*/adminhtml_amazon_listing/view/back/'
                                       .Mage::helper('M2ePro')
                ...
                array(
                    ...
                    'url' => array(
                                'base'=> '*/adminhtml_amazon_listing/product/back/'
                ...
                array(
                    ...
                    'url' => array(
                                'base'=> '*/adminhtml_amazon_listing/categoryProduct/back/'
                                         .Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_listing/index',
                                            array('tab'=>
                                                    Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_AMAZON)).
                                         '/'
                ...
                array(
                    ...
                    'url' => array(
                                'base'=> '*/adminhtml_amazon_listing/edit/back/'
                                         .Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_listing/index',
                                            array('tab'=>
                                                    Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_AMAZON)).
                                         '/'
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete_listings', array(
             ...
             'url'      => $this->getUrl('*/adminhtml_'.Ess_M2ePro_Helper_Component_Amazon::NICK.'_listing/delete'),
             'confirm'  => Mage::helper('M2ePro')->__('Are you sure?')
        ));
        //--------------------------------
    ...
    {
        $tabIdAmazon = Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_AMAZON;
        return $this->getUrl('*/adminhtml_amazon_listing/view',
                             array('id' => $row->getId(),
