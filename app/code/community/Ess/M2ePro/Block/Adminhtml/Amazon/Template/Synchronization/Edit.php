...
class Ess_M2ePro_Block_Adminhtml_Amazon_Template_Synchronization_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_addButton('back', array(
            ...
            'onclick'   => 'AmazonTemplateSynchronizationHandlerObj.back_click(\''
