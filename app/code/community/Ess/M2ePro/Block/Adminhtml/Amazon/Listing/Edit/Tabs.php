    ...
    protected function _beforeToHtml()
    {
        $this->addTab('settings', array(
            ...
            'content' => $this->getLayout()
                              ->createBlock('M2ePro/adminhtml_amazon_listing_edit_tabs_settings')
                              ->toHtml(),
        ));
        ...
        $this->addTab('channel', array(
            ...
            'content' => $this->getLayout()
                              ->createBlock('M2ePro/adminhtml_amazon_listing_edit_tabs_channelSettings')
                              ->toHtml(),
        ));
        ...
        $this->addTab('products_filter', array(
            ...
            'content' => $this->getLayout()
                              ->createBlock('M2ePro/adminhtml_amazon_listing_edit_tabs_ProductsFilter')
                              ->toHtml(),
        ));
