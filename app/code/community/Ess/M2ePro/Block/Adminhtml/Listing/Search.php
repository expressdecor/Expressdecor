...
<ul style="display: none;">
    <li href="{$this->getUrl('*/adminhtml_template_sellingFormat/index')}" target="_blank">
        {$sellingFormatTemplate}
    </li>
    <li href="{$this->getUrl('*/adminhtml_template_description/index')}" target="_blank">
        {$descriptionTemplate}
    </li>
    <li href="{$this->getUrl('*/adminhtml_template_general/index')}" target="_blank">
        {$generalTemplate}
    </li>
    <li href="{$this->getUrl('*/adminhtml_template_synchronization/index')}" target="_blank">
