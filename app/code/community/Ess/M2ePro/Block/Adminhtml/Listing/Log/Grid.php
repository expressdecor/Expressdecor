        ...
        if (count(Mage::helper('M2ePro/Component')->getActiveComponents()) == 1) {
            if (Mage::helper('M2ePro/Component_Ebay')->isActive()) {
                $collection->getSelect()->where(
                    'component_mode = ? OR component_mode IS NULL',Ess_M2ePro_Helper_Component_Ebay::NICK
                );
            }
            if (Mage::helper('M2ePro/Component_Amazon')->isActive()) {
                $collection->getSelect()->where(
                    'component_mode = ? OR component_mode IS NULL',Ess_M2ePro_Helper_Component_Amazon::NICK
                );
            }
        }
