...
class Ess_M2ePro_Block_Adminhtml_Listing_Other_MapToProduct_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('listingOtherMapToProductGrid');
        //------------------------------
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addFieldToFilter('type_id',Ess_M2ePro_Model_Magento_Product::TYPE_SIMPLE);
    ...
    public function callbackColumnActions($value, $row, $column, $isExport)
    {
        ...
        $return .= '$(\'sku\').setValue(\'\'); ';
        $return .= '$$(\'.mapToProduct_submit_button\')[0].click(); ">';
...
<script type="text/javascript">
    ...
    $$('#listingOtherMapToProductGrid div.grid th').each(function(el){
        el.style.padding = '2px 4px';
    });

    $$('#listingOtherMapToProductGrid div.grid td').each(function(el){
        el.style.padding = '2px 4px';
    });
...
JAVASCRIPT;
    ...
    {
        return $this->getUrl('*/adminhtml_listingOther/mapToProductGrid', array('_current'=>true));
    }
