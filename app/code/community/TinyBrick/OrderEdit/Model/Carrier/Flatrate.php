 ...
 */
class TinyBrick_OrderEdit_Model_Carrier_Flatrate extends Mage_Shipping_Model_Carrier_Flatrate
{
            ...
            foreach ($request->getAllItems() as $item) {
                ...
                if ($item->getHasChildren() && $item->isShipSeparately()) {
                    ...
                    $freeBoxes += $item->getQty();
                      ...
                      //$this->getProductId()
                //Mage::cDebug('TinyBrick_OrderEdit_Model_Carrier_Flatrate', print_r($item->getProductId(),true));
