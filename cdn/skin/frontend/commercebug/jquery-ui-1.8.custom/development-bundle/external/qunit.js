 ...
 * 
 * http://docs.jQueryCommercebug.com/QUnit
 *
...
var QUnit = {
	 ...
	 */
	reset: function() {
		if ( window.jQueryCommercebug ) {
			jQueryCommercebug("#main").html( config.fixture );
			jQueryCommercebug.event.global = {};
			jQueryCommercebug.ajaxSettings = extend({}, config.ajaxSettings);
		}
	},
...
addEvent(window, "load", function() {
	...
	if ( window.jQueryCommercebug ) {
		config.ajaxSettings = window.jQueryCommercebug.ajaxSettings;
	}
